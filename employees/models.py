...
class Employee(models.Model):
    file = models.FileField(default=None, verbose_name="Object Upload",
                            storage=MinioBackend(bucket_name='private'),
                            upload_to=iso_date_prefix, blank=True, null=True)
    uuid = models.UUIDField(default=uuid4, primary_key=True, editable=False)
    enrollment = models.CharField(
        _('num empleado'), max_length=10, unique=True)
